...
function App() {
  ...
  return (
    <Box className="App" sx={{ m: 0, p: 0, bgcolor: 'background.default' }}>
      <Navbar />
      <Container
        maxWidth={isSmall ? false : undefined}
        disableGutters={isSmall}
        component={'main'} sx={{ minHeight: 1500, bgcolor: 'background.default', pl: '0px!important', pr: '0px!important', pt: 0, overflowY: 'hidden', mb: isMobile ? "50px" : undefined }}>
        <Routes>
